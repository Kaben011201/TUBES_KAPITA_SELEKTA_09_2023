            ...
            <div className="flex gap-5 xl:gap-8">
              <label className="w-[23%] xl:w-[18%] text-end font-medium leading-[1.2]" htmlFor="">Masa Neonatal</label>
                <div className="w-[77%] xl:w-[82%] flex flex-col gap-[7px] text-[11px] xl:text-base xl:font-medium font-semibold">
                    <div className="flex gap-3 xl:gap-4 items-center">
                        <label className="w-[45%] xl:w-[20%]" htmlFor="">1. 6-48 jam</label>
                        <input className="w-[45%] xl:w-[70%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="Neo1" id="Neo1" value={"-"} />
                    </div>

                    <div className="flex gap-3 xl:gap-4 items-center">
                        <label className="w-[45%] xl:w-[20%]" htmlFor="">2. Hari ke 3-28</label>
                        <input className="w-[45%] xl:w-[70%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="Neo2" id="Neo2" value={"-"}/>
                    </div>

                    <div className="flex gap-3 xl:gap-4 items-center">
                        <label className="w-[45%] xl:w-[20%]" htmlFor="">3. Hari ke 8-28</label>
                        <input className="w-[45%] xl:w-[70%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="Neo3" id="Neo3" value={"-"}/>
                    </div>
                </div>
            </div>
      ...
      <dialog id="modal_edit_lansia" className="modal">
        <div className="modal-box xl:max-w-7xl">
          ...
          <form action="" className="flex flex-col gap-[7px] text-[12px] xl:text-base mt-6 xl:mt-6 whitespace-normal">
            ...
            <div className="flex gap-3 xl:gap-4 items-center">
              <label className="w-[23%] xl:w-[18%] text-end font-medium leading-[1.2]" htmlFor="">Alamat Domisili KK<span className="text-red-500 absolute mt-[-35px] xl:mt-[-6px]">*</span></label>
            ...
            <div className="flex gap-3 xl:gap-4 items-center">
              <label className="w-[23%] xl:w-[18%] text-end font-medium leading-[1.2]" htmlFor="">Tensi Darah (mmHg)<span className="text-red-500 absolute mt-[-35px] xl:mt-[-6px]">*</span></label>

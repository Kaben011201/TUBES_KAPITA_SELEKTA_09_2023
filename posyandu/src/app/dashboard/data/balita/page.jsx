...
const DataBalita = () => {
  ...
  const [balitaFilter, setBalitaFilter] = useState([]);
      ...
      return (
        <tr key={balita.id}>
          ...
          <td className="whitespace-nowrap">
            ...
            {/* Hapus data */}
            <button onClick={() => deleteData(balita)}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22.5"
                height="22.5"
          ...
          {/* modal tambah balita*/}
          <dialog id="modal_tambah_balita" className="modal">
            <div className="modal-box xl:max-w-7xl">
              <form method="dialog">
                {/* if there is a button in form, it will close the modal */}
                <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">
                  ...
                  <div className="w-[77%] xl:w-[82%] flex flex-col gap-[7px] text-[11px] xl:text-base xl:font-medium font-semibold">
                    ...
                    <div className="flex gap-3 xl:gap-4 items-center">
                      ...
                      <input
                        ...
                        name="tanggalPra"
                        id="tanggalPra"
                        value={changeDateEdit(inputs.tanggalPra)}
                        onChange={handleInputs}
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-[77%] xl:w-[82%] flex flex-col gap-[7px] font-semibold xl:font-medium text-[11px] xl:text-base">
                    <div className="flex gap-3 xl:gap-4 items-center">
                      ...
                      <input
                        ...
                        name="tanggalMeninggal"
                        id="tanggalMeninggal"
                        value={changeDateEdit(inputs.tanggalMeninggal)}
                        onChange={handleInputs}
                      />
                    </div>

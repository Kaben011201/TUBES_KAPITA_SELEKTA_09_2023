    ...
    <main className="flex">
      ...
      <form action="" className="flex flex-col gap-[7px] text-[12px] xl:text-base my-2 xl:mt-6">
        <div className="flex gap-3 xl:gap-4 items-center">
          <label className="w-[23%] xl:w-[18%] text-end font-medium leading-[1.2]" htmlFor="">Tanggal Kunjungan<span className="text-red-500 absolute mt-[-20px] xl:mt-[-6px]">*</span></label>
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="date" name="kunjung" id="kunjung" value={inputs.kunjung} onChange={handleInput} required/>
        </div>
        <div className="flex gap-3 xl:gap-4 items-center">
          <label className="w-[23%] xl:w-[18%] text-end font-medium" htmlFor="">NIK</label>
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="nik" id="nik" value={inputs.nik} onChange={handleInput} />
        </div>
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="nama" id="nama" value={inputs.nama} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="date" name="tanggalLahir" id="tanggalLahir" value={inputs.tanggalLahir} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="nikIbu" id="nikIbu" value={inputs.nikIbu} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="ayah" id="ayah" value={inputs.ayah} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="nikAyah" id="nikAyah" value={inputs.nikAyah} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <textarea className="w-[77%] xl:w-[82%] border-[1.5px] border-[#D5D8DE] rounded-sm p-2 resize-none" name="alamat" id="alamat" rows="3" value={inputs.alamat} onChange={handleInput} required></textarea>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <textarea className="w-[77%] xl:w-[82%] border-[1.5px] border-[#D5D8DE] rounded-sm p-2 resize-none" name="alamatKK" id="alamatKK" rows="3" value={inputs.alamatKK} onChange={handleInput} required></textarea>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="number" name="bb" id="bb" value={inputs.bb} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="number" name="tb" id="tb" value={inputs.tb} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="number" name="lk" id="lk" value={inputs.lk} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="number" name="ll" id="ll" value={inputs.ll} onChange={handleInput} required/>
        </div>
          ...
          <label className="w-[23%] xl:w-[18%] text-end font-medium leading-[1.2]" htmlFor="">Meninggal</label>
            <div className="w-[77%] xl:w-[82%] flex flex-col gap-[7px] font-semibold xl:font-medium text-[11px] xl:text-base">
                <div className="flex gap-3 xl:gap-4 items-center">
                    ...
                    <input className="w-[70%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2 font-medium" type="date" name="tanggalMeninggal" id="tanggalMeninggal" value={inputs.tanggalMeninggal} onChange={handleInput} />
                </div>

                <div className="flex gap-3 xl:gap-4 items-center">
                    <label className="w-[30%] xl:w-[10%]" htmlFor="">Penyebab</label>
                    <input className="w-[70%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="penyebab" id="penyebab" value={inputs.penyebab} onChange={handleInput} />
                </div>
            </div>
        </div>

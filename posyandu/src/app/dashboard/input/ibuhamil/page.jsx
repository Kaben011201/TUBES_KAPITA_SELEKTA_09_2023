    ...
    <main className="flex justify-center">
      ...
      <form action="" className="flex flex-col gap-[7px] text-[12px] xl:text-base my-2 xl:mt-6">
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <textarea className="w-[77%] xl:w-[82%] border-[1.5px] border-[#D5D8DE] rounded-sm p-2 resize-none" name="alamatKK" id="alamatKK" rows="3" value={"Karimun cina"} required></textarea>
        </div>

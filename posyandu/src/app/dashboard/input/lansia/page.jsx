    ...
    <main className="flex">
      ...
      <form action="" className="flex flex-col gap-[7px] text-[12px] xl:text-base my-2 xl:mt-6">
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="date" name="kunjung" id="kunjung" value={""} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="nokk" id="nokk" value={inputs.nokk} onChange={handleInput} />
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2 px-2" type="date" name="ttl" id="ttl" value={inputs.ttl} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-6 items-center my-4">
          ...
          <div className="flex flex-row gap-10 xl:gap-32">
            <div className="flex gap-2">
              <input className="accent-pink-500" type="radio" name="jenkel" id="pria" checked={inputs.jenkel = 'L'} value={inputs.jenkel} onChange={handleInput} required/>
              <label htmlFor="">Laki-laki</label>
            </div>
            <div className="flex gap-2">
              <input className="accent-pink-500" type="radio" name="jenkel" id="wanita" checked={inputs.jenkel = 'P'} value={inputs.jenkel} onChange={handleInput} />
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="number" name="tensi" id="tensi" value={inputs.tensi} onChange={handleInput} required/>
        </div>
        ...
        <div className="flex gap-3 xl:gap-4 items-center">
          ...
          <input className="w-[77%] xl:w-[82%] h-9 xl:h-11 border-[1.5px] border-[#D5D8DE] rounded-sm p-2" type="text" name="BPJS" id="BPJS" value={inputs.BPJS} onChange={handleInput} required/>
        </div>
